...
public class ModFluids
{
    ...
    public static final ForgeFlowingFluid.Properties OIL_PROPERTIES =
            new ForgeFlowingFluid.Properties(
                    () -> OIL_FLUID.get(),
                    () -> OIL_FLOWING.get(),
                    FluidAttributes.builder(OIL_STILL_RL, OIL_FlOWING_RL)
                    .density(15).luminosity(4).rarity(Rarity.EPIC).sound(SoundEvents.BLOCK_BUBBLE_COLUMN_BUBBLE_POP)
                    .overlay(OIL_OVERLAY_RL).viscosity(6)).slopeFindDistance(4).levelDecreasePerBlock(3)
